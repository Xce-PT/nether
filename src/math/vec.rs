...
impl Vector {
    ...
    ///
    /// Returns the computed result with the corss product in the first three components and the dot product in the fourth component.
    ///
    /// The fourth dimension of both vectors is ignored, since the cross product is not possible in four dimensions.
